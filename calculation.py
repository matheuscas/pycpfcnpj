...
def first_check_digit(number,weighs):
	""" This function calculates the first check digit to 
	    ...
	    :param number: cpf or cnpj number to check the first digit.  Only numbers.
	    :type number: string
	    :param weighs: weighs related to first check digit calculation
...
def second_check_digit(updated_number, weighs):
	""" This function calculates the second check digit to 
	    ...
	    **This function must be called after the above.**
	    ...
	    :param updated_number: cpf or cnpj number with the first digit.  Only numbers.
	    :type number: string
