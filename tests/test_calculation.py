...
class CalculationTests(unittest.TestCase):
    ...
    def test_cpf_calculate_first_digit_true(self):
        ...
        self.assertEqual(
            correct_first_digit, calc.calculate_first_digit(self.first_part_cpf_number)
        )

    def test_cpf_calculate_first_digit_false(self):
        incorrect_first_digit = "6"
        self.assertNotEqual(
            incorrect_first_digit, calc.calculate_first_digit(self.first_part_cpf_number)
        )

    def test_cpf_calculate_second_digit_true(self):
        updated_cpf_number = self.first_part_cpf_number + calc.calculate_first_digit(
            self.first_part_cpf_number
        )
        correct_second_digit = "5"
        self.assertEqual(correct_second_digit, calc.calculate_second_digit(updated_cpf_number))
    ...
    def test_cpf_calculate_second_digit_false(self):
        ...
        self.assertNotEqual(incorrect_second_digit, calc.calculate_second_digit(updated_cpf_number))

    # TESTS FOR CNPJ DIGITS
    def test_cnpj_calculate_first_digit_true(self):
        correct_first_digit = "6"
        self.assertEqual(
            correct_first_digit, calc.calculate_first_digit(self.first_part_cnpj_number)
        )
    ...
    def test_cnpj_calculate_second_digit_true(self):
        ...
        updated_cnpj_number = self.first_part_cnpj_number + calc.calculate_first_digit(
            self.first_part_cnpj_number
        )
        self.assertEqual(correct_second_digit, calc.calculate_second_digit(updated_cnpj_number))
    ...
    def test_cnpj_calculate_second_digit_false(self):
        ...
        self.assertNotEqual(correct_second_digit, calc.calculate_second_digit(updated_cnpj_number))
